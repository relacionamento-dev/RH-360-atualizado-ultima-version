        ...
        <div className="w-full lg:w-[45%] max-w-[480px]">
          <div className="bg-white rounded-[32px] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.06)] p-8 md:p-12 space-y-8">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <span className="relative bg-white px-4 text-[12px] font-bold text-gray-400 uppercase tracking-widest">ou</span>
            </div>

            <button className="w-full h-14 border border-gray-200 hover:bg-gray-50 rounded-2xl flex items-center justify-center gap-3 transition-all">
