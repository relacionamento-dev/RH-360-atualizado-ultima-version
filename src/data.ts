...
export const INITIAL_JOBS: Job[] = [
  ...
  // VAGAS DA TECHFLOW
  //
  // O quadro da segunda empresa existia sem nenhuma vaga, então "Vagas Abertas"
  // dava zero nela — e, antes do recorte por empresa, dava o número da RH360 nas
  // duas. Estrutura própria da TechFlow: filiais, setores e centros de custo
  // dela (TECHFLOW_BRANCHES / TECHFLOW_SECTORS / TECHFLOW_COST_CENTERS).
  {
    id: 'tf-v1',
    code: 'TF-VAGA-2026-001',
    title: 'Engenheiro de Dados',
    company: 'TechFlow Solutions',
    branch: 'Sede Florianópolis',
  ...
  {
    id: 'tf-v2',
    code: 'TF-VAGA-2026-002',
    title: 'Product Designer Pleno',
    company: 'TechFlow Solutions',
    branch: 'Unidade Remota',
    department: 'Produto',
    sector: 'Produto',
    costCenter: 'PRD-200',
    location: 'Remoto',
