...
export const INITIAL_RH_PROCESSES: RHProcess[] = [
  ...
  { id: '5', name: 'Recebimento de VR/VA', description: 'Confirmação mensal de recebimento de benefícios', icon: 'CreditCard', pendingCount: 3, ativo: true, category: 'Benefícios', viewType: 'vr-va', targetMode: TargetMode.CURRENT_USER, roles: { employee: true, manager: false, hr: true, director: false }, etapas: ['Solicitado', 'Processado', 'Entregue'], version: 1, isSensitive: false, allowDraft: false, allowCancel: false, approvals: [], handoffs: { updateProfile: false, createRecord360: false, createTask: false, generateDoc: false, requireSignature: false, handoffType: 'desativado' }, aiConfig: { enabled: false, points: [], model: '', purpose: '', requireReview: true } },
  ...
  INITIAL_RH_PROCESSES.forEach(p => {
    ...
    const getMockData = (pid: string) => {
      switch(pid) {
        ...
        case '5': return { competencia: 'Março/2026', beneficio: 'Vale Refeição', valorQuantidade: 850.00, dataRecebimento: '2026-03-05', situacao: 'Confirmado', observacao: 'Crédito recebido corretamente.' };
